...
public class Preconditions {
  ...
  public static final BiFunction<String, List<Number>, StringIndexOutOfBoundsException>
    SIOOBE_FORMATTER = Preconditions.outOfBoundsExceptionFormatter(StringIndexOutOfBoundsException::new);

  public static final BiFunction<String, List<Number>, ArrayIndexOutOfBoundsException>
    AIOOBE_FORMATTER = Preconditions.outOfBoundsExceptionFormatter(ArrayIndexOutOfBoundsException::new);

  public static final BiFunction<String, List<Number>, IndexOutOfBoundsException>
    IOOBE_FORMATTER = Preconditions.outOfBoundsExceptionFormatter(IndexOutOfBoundsException::new);
