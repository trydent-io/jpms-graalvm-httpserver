...
public final class ObjectIdentifier implements Serializable {
  ...
  private void writeObject(ObjectOutputStream os)
    ...
    if (!componentsCalculated) {
      ...
      if (comps != null) {    // every one understands this
        ...
        components = ObjectIdentifier.HugeOidNotSupportedByOldJDK.theOne;
      }
  ...
  static class HugeOidNotSupportedByOldJDK implements Serializable {
    ...
    static ObjectIdentifier.HugeOidNotSupportedByOldJDK theOne =
      new ObjectIdentifier.HugeOidNotSupportedByOldJDK();
  }
